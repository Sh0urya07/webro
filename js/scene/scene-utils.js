...
export function makeRenderer(canvas, dpr, opts = {}) {
  // When a bloom/EffectComposer pipeline is used, canvas-level MSAA is wasted
  // work (the composed passes ignore it) — callers pass antialias:false.
  const antialias = opts.antialias !== undefined ? opts.antialias : dpr < 2;
